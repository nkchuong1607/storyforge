...
**Do not skip specs.** Phase contracts: [Phase 1](../specs/phase-1/README.md), [Phase 2](../specs/phase-2/README.md), [Phase 3](../specs/phase-3/README.md).
...
- **Scope:** Phase 1 UI modules — see [web-screens.md](../specs/phase-1/web-screens.md); Phase 2 — [web-screens.md](../specs/phase-2/web-screens.md); Phase 3 — [web-screens.md](../specs/phase-3/web-screens.md)
...
See [Phase 1 test strategy](../specs/phase-1/test-strategy.md), [Phase 2 test strategy](../specs/phase-2/test-strategy.md), and [Phase 3 test strategy](../specs/phase-3/test-strategy.md).
