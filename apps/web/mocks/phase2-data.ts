  ...
  [CHAPTER_2_ID]: [
    {
      ...
      goal: "Vào môn phái",
      conflict: "",
      outcome: "Được nhận làm đệ tử",
      stakes_level: 2,
      pressure_tags: [],
      scene_type: "scene",
      pov_character_id: "990e8400-e29b-41d4-a716-446655440001",
  ...
  [CHAPTER_3_ID]: [
    {
      ...
      issues: [
        ...
        {
          fingerprint: "stakes:660e8400-e29b-41d4-a716-446655440001:flat_middle:act2:ch3",
          severity: "warn",
          category: "stakes",
          code: "stakes_flat_middle",
          message: "Giữa truyện phẳng — act 2 chưa leo thang stakes",
          chapter_refs: [3],
        },
        {
          fingerprint: "scene_structure:aa0e8400-e29b-41d4-a716-446655440001:missing_conflict",
          severity: "warn",
          category: "scene_structure",
          code: "scene_missing_conflict",
          message: "Beat thiếu xung đột",
          chapter_refs: [2],
