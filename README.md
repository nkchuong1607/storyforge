...
2. Read [AGENTS.md](./AGENTS.md) → relevant docs → `skills/*/SKILL.md`
3. Follow `.cursor/rules/` (Cursor applies these automatically)
4. Run `make check` before finishing

### First-party skills (`skills/`)

Domain and stack skills: architecture, canon, continuity, characters, twists, psychology, power system, API, web, DB design, UI external wrapper.
